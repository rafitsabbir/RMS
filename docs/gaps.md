...
| G35 | Build | Build portability | Missing link | Fixed 2026-09-26 | Was: no compiler level, so Maven defaulted to Java 1.5. Now `pom.xml:16-17` sets 1.8 and `pom.xml:125-148` pins the compiler, surefire and war plugins | Low | S | Confirmed |
