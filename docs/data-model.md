...
- **No date or time columns:** the row mappers read columns only with `getInt`/`getString` (`LoginDaoImpl.java:33-41`, `MarksDaoImpl.java:40-55`, `PositionDaoImpl.java:44-45`, `LanguageDaoImpl.java:46-47`).